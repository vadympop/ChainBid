...
export const Header = () => {
  ...
  return (
    <>
      ...
      <aside className="group fixed left-0 top-0 z-30 hidden bg-black h-screen w-[72px] flex-col items-center overflow-hidden border-r border-white/10 py-4 transition-[width] duration-200 hover:w-[200px] lg:flex">
